...
public final class CommonTestConstants {
     ...
     * </pre>
     */
    public final static SudokuBoard VALID_BOARD_SAMPLE = new SudokuBoard(new Integer[][]{
    ...
    public final static SudokuBoard VALID_BOARD_RESULT = new SudokuBoard(new Integer[][]{
